...
export const WORK = [
  {
    ...
    thumb: "/assets/work/summit-thumb.webp",
    full: "/assets/work/summit-full.webp",
  ...
  },
  {
    ...
    thumb: "/assets/work/the-rocks-thumb.webp",
    full: "/assets/work/the-rocks-full.webp",
  ...
  },
  {
    ...
    kind: "plate",
    title: "APRILIA RSV4",
    subtitle: "Carbon Edition \u2014 Spec Poster",
    category: "Automotive / Technical",
    year: "2025",
    tags: ["Automotive", "Technical Poster", "Typography", "Canva Pro"],
    blurb:
      "High-impact product poster with bold typography, split-color layout and technical data visualization. Designed for both digital feeds and print-ready output.",
    plate: {
      marque: "APRILIA",
      model: "RSV4",
  ...
  },
  {
    ...
    blurb:
      "Brand-aligned product showcase featuring technical specs, a clean visual hierarchy and a striking palette. Optimized for social media and promotional use.",
    plate: {
      marque: "PORSCHE",
      model: "911 GT3 RS",
      edition: "TYPE 992",
